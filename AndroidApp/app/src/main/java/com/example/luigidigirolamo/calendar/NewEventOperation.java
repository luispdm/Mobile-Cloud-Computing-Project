 ...
 */
public class NewEventOperation extends AsyncTask<JSONObject, Void, String> {
    Activity activity;

    public NewEventOperation(Activity activity) {
    ...
    protected String doInBackground(JSONObject... params) {
        ...
        String response = "";
        try {
            url = new URL(address+"users/"+uI.getUserName()+"/token/"+uI.getToken()+"/events");
