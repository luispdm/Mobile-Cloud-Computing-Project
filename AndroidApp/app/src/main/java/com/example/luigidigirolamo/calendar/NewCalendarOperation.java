 ...
 */
public class NewCalendarOperation extends AsyncTask<JSONObject, Void, String> {
    Activity activity;
    public NewCalendarOperation(Activity activity) {
    ...
    protected String doInBackground(JSONObject... params) {
        ...
        String response = "";
        try {
            url = new URL(address+"users/"+uI.getUserName()+"/token/"+uI.getToken()+"/calendars");
