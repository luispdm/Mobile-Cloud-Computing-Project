 ...
 */
public class UpdateCalendarOperation extends AsyncTask<JSONObject, Void, String> {
    Activity activity;

    public UpdateCalendarOperation(Activity activity) {
    ...
    protected String doInBackground(JSONObject... params) {
        ...
        String response = "";
        try {
            url = new URL(address+"users/"+uI.getUserName()+"/token/"+uI.getToken()+"/calendars/"+UpdateCalendarActivity.calendarId);
